  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-12">
      ...
      <section className="mt-6 rounded-3xl border bg-[var(--surface)] p-7 sm:p-9">
        ...
        <div className="mt-7"><PageNotice error={error} /></div>
        <form action={createGroup} className="space-y-5">
          ...
          <button type="submit" className="w-full rounded-xl bg-[var(--accent)] px-5 py-3 font-bold text-[#07150c] transition">Criar grupo</button>
        </form>
      </section>
    </main>
  );

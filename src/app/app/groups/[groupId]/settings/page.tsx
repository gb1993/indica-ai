  ...
  return (
    <main id="main-content" className="app-page max-w-3xl">
      ...
      <section className="app-panel mt-6 p-7 sm:p-9">
        <p className="mb-2 text-xs font-semibold uppercase tracking-[0.14em] text-(--accent-strong)">Gerenciar grupo</p>
        <h1 className="text-3xl font-bold tracking-tight">Configurações</h1>
        <div className="mt-6"><GroupForm group={group} /></div>
      </section>
      <section className="mt-6 rounded-2xl border border-red-500/30 bg-red-500/5 p-7">
